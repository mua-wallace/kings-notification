    ...
    if (!payload.message) {
      ...
      <html lang="en">
          <head>
              ...
              <title>${payload.subject} account on kingsschool</title>
          ...
          <body>
              <div class="flex items-center justify-center min-h-screen p-5 bg-gray-600 min-w-screen">
                  <div class="max-w-xl p-8 text-center text-gray-800 bg-white shadow-xl lg:max-w-3xl rounded-3xl lg:p-12">
                      <h3 class="text-2xl">Hi, Welcome to kingsschool!</h3>
                      ...
                      <p>We're happy you're here. Please use the credentials below to log into your school account</p>
                      <div class="mt-4">
                         <div class="flex justify-between items-center mt-4">
                            <div class="text-blue-200">
                            <p class="text-sm text-gray-600">Email  </p> ${payload.receipient.email}
                            </div>
                            <div class="text-blue-200">
                            <p class="text-sm text-gray-600">Password </p> ${payload.subject}
                            </div>
                         </div>
                          <p class="mt-4 text-sm">
                          Please ensure that you reset your password upon first login. 
                          <br> 
                          If you have any questions, please contact us at <a href="https://www.kingscorp.xyz">kingssoftwares</a>
                          </p>
                      </div>
                  </div>
              </div>
